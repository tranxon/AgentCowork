...
//! - `rollball_execute(ptr, len)` — invoke a nested tool call
//! - `rollball_schema()` — get tool's JSON schema
//!
...
impl HostFunctions {
    ...
    /// Get the function type for `rollball_execute`.
    ...
    /// Get the function type for `rollball_log`.
